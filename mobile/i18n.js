...
const STR = {
  ja: {
    ...
    'areasel.buildingsTierLabel': '建物データ',
    'areasel.buildingsTierNone': '建物データなし',
    'areasel.buildingsTierSimple': '建物データ有り(簡易 Wi-Fi環境推奨)',
    'areasel.buildingsTierDetailed': '建物データ有り(詳細 Wi-Fi環境推奨 高負荷)',
  ...
  en: {
    ...
    'areasel.buildingsTierLabel': 'Building data',
    'areasel.buildingsTierNone': 'No building data',
    'areasel.buildingsTierSimple': 'Buildings (light — Wi-Fi recommended)',
    'areasel.buildingsTierDetailed': 'Buildings (detailed — Wi-Fi recommended, high load)',
  ...
  pt: {
    ...
    'areasel.buildingsTierLabel': 'Dados de prédios',
    'areasel.buildingsTierNone': 'Sem dados de prédios',
    'areasel.buildingsTierSimple': 'Prédios (leve — Wi-Fi recomendado)',
    'areasel.buildingsTierDetailed': 'Prédios (detalhado — Wi-Fi recomendado, alta carga)',
  ...
  pl: {
    ...
    'areasel.buildingsTierLabel': 'Dane budynków',
    'areasel.buildingsTierNone': 'Bez danych budynków',
    'areasel.buildingsTierSimple': 'Budynki (lekkie — zalecane Wi-Fi)',
    'areasel.buildingsTierDetailed': 'Budynki (szczegółowe — zalecane Wi-Fi, duże obciążenie)',
  ...
  fr: {
    ...
    'areasel.buildingsTierLabel': 'Données des bâtiments',
    'areasel.buildingsTierNone': 'Sans données de bâtiments',
    'areasel.buildingsTierSimple': 'Bâtiments (léger — Wi-Fi recommandé)',
    'areasel.buildingsTierDetailed': 'Bâtiments (détaillé — Wi-Fi recommandé, charge élevée)',
  ...
  de: {
    ...
    'areasel.buildingsTierLabel': 'Gebäudedaten',
    'areasel.buildingsTierNone': 'Keine Gebäudedaten',
    'areasel.buildingsTierSimple': 'Gebäude (einfach — WLAN empfohlen)',
    'areasel.buildingsTierDetailed': 'Gebäude (detailliert — WLAN empfohlen, hohe Last)',
  ...
  es: {
    ...
    'areasel.buildingsTierLabel': 'Datos de edificios',
    'areasel.buildingsTierNone': 'Sin datos de edificios',
    'areasel.buildingsTierSimple': 'Edificios (ligero — Wi-Fi recomendado)',
    'areasel.buildingsTierDetailed': 'Edificios (detallado — Wi-Fi recomendado, carga alta)',
